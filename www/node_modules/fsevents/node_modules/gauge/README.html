<h1>gauge</h1><p>A nearly stateless terminal based horizontal gauge / progress bar.</p>
...
<h4><code>gauge.isEnabled()</code></h4><p>Returns true if the gauge is enabled.</p>
