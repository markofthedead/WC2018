<h1>Commander.js</h1><p><a href="http://travis-ci.org/tj/commander.js"><img src="https://api.travis-ci.org/tj/commander.js.svg?branch=master" alt="Build Status"></a>
...
<h2>Installation</h2><pre><code>$ npm install commander --save
...
<h2>Version option</h2><p>Calling the <code>version</code> implicitly adds the <code>-V</code> and <code>--version</code> options to the command.
When either of these options is present, the command prints the version number and exits.</p>
<pre><code>$ ./examples/pizza -V
0.0.1
</code></pre><p>If you want your program to respond to the <code>-v</code> option instead of the <code>-V</code> option, simply pass custom flags to the <code>version</code> method using the same syntax as the <code>option</code> method.</p>
<pre><code class="language-js">program
  .version(&#39;0.0.1&#39;, &#39;-v, --version&#39;)
</code></pre>
<p>The version flags can be named anything, but the long option is required.</p>
<h2>Command-specific options</h2><p>You can attach options to a command.</p>
<pre><code class="language-js">#!/usr/bin/env node
