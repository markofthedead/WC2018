...
<h3>Nan::FunctionCallbackInfo</h3><p><code>Nan::FunctionCallbackInfo</code> should be used in place of <a href="https://v8docs.nodesource.com/node-8.0/dd/d0d/classv8_1_1_function_callback_info.html"><code>v8::FunctionCallbackInfo</code></a>, even with older versions of Node where <code>v8::FunctionCallbackInfo</code> does not exist.</p>
<p>Definition:</p>
...
<h3>Nan::PropertyCallbackInfo</h3><p><code>Nan::PropertyCallbackInfo</code> should be used in place of <a href="https://v8docs.nodesource.com/node-8.0/d7/dc5/classv8_1_1_property_callback_info.html"><code>v8::PropertyCallbackInfo</code></a>, even with older versions of Node where <code>v8::PropertyCallbackInfo</code> does not exist.</p>
<p>Definition:</p>
...
<h3>Method declaration</h3><p>JavaScript-accessible methods should be declared with the following signature to form a <code>Nan::FunctionCallback</code>:</p>
...
<h3>Getter declaration</h3><p>JavaScript-accessible getters should be declared with the following signature to form a <code>Nan::GetterCallback</code>:</p>
...
<h3>Setter declaration</h3><p>JavaScript-accessible setters should be declared with the following signature to form a <b><code>Nan::SetterCallback</code></b>:</p>
...
<h3>Property getter declaration</h3><p>JavaScript-accessible property getters should be declared with the following signature to form a <b><code>Nan::PropertyGetterCallback</code></b>:</p>
...
<h3>Property setter declaration</h3><p>JavaScript-accessible property setters should be declared with the following signature to form a <b><code>Nan::PropertySetterCallback</code></b>:</p>
...
<h3>Property enumerator declaration</h3><p>JavaScript-accessible property enumerators should be declared with the following signature to form a <b><code>Nan::PropertyEnumeratorCallback</code></b>:</p>
...
<h3>Property deleter declaration</h3><p>JavaScript-accessible property deleters should be declared with the following signature to form a <b><code>Nan::PropertyDeleterCallback</code></b>:</p>
...
<h3>Property query declaration</h3><p>JavaScript-accessible property query methods should be declared with the following signature to form a <b><code>Nan::PropertyQueryCallback</code></b>:</p>
...
<h3>Index getter declaration</h3><p>JavaScript-accessible index getter methods should be declared with the following signature to form a <b><code>Nan::IndexGetterCallback</code></b>:</p>
...
<h3>Index setter declaration</h3><p>JavaScript-accessible index setter methods should be declared with the following signature to form a <b><code>Nan::IndexSetterCallback</code></b>:</p>
...
<h3>Index enumerator declaration</h3><p>JavaScript-accessible index enumerator methods should be declared with the following signature to form a <b><code>Nan::IndexEnumeratorCallback</code></b>:</p>
...
<h3>Index deleter declaration</h3><p>JavaScript-accessible index deleter methods should be declared with the following signature to form a <b><code>Nan::IndexDeleterCallback</code></b>:</p>
...
<h3>Index query declaration</h3><p>JavaScript-accessible index query methods should be declared with the following signature to form a <b><code>Nan::IndexQueryCallback</code></b>:</p>
...
<h3>Nan::SetMethod()</h3><p>Sets a method with a given name directly on a JavaScript object where the method has the <code>Nan::FunctionCallback</code> signature (see <a href="#api_nan_method">Method declaration</a>).</p>
<p>Signature:</p>
...
<h3>Nan::SetPrototypeMethod()</h3><p>Sets a method with a given name on a <code>FunctionTemplate</code>&#39;s prototype where the method has the <code>Nan::FunctionCallback</code> signature (see <a href="#api_nan_method">Method declaration</a>).</p>
<p>Signature:</p>
...
<h3>Nan::SetNamedPropertyHandler()</h3><p>Sets named property getters, setters, query, deleter and enumerator methods on an <code>ObjectTemplate</code>. Accepts:</p>
<ul>
...
<h3>Nan::SetIndexedPropertyHandler()</h3><p>Sets indexed property getters, setters, query, deleter and enumerator methods on an <code>ObjectTemplate</code>. Accepts:</p>
<ul>
...
<h3>Nan::SetTemplate()</h3><p>Adds properties on an <code>Object</code>&#39;s or <code>Function</code>&#39;s template.</p>
<p>Signature:</p>
...
<h3>Nan::SetPrototypeTemplate()</h3><p>Adds properties on an <code>Object</code>&#39;s or <code>Function</code>&#39;s prototype template.</p>
<p>Signature:</p>
...
<h3>Nan::SetInstanceTemplate()</h3><p>Use to add instance properties on <code>FunctionTemplate</code>&#39;s.</p>
<p>Signature:</p>
...
<h3>Nan::SetCallHandler()</h3><p>Set the call-handler callback for a <code>v8::FunctionTemplate</code>.
...
<h3>Nan::SetCallAsFunctionHandler()</h3><p>Sets the callback to be used when calling instances created from the <code>v8::ObjectTemplate</code> as a function.
...
<p>Calls the <code>ObjectTemplate</code>&#39;s <a href="https://v8docs.nodesource.com/node-8.0/db/d5f/classv8_1_1_object_template.html#a5e9612fc80bf6db8f2da199b9b0bd04e"><code>SetCallAsFunctionHandler()</code></a>.</p>
