<h2>Errors</h2><p>NAN includes helpers for creating, throwing and catching Errors as much of this functionality varies across the supported versions of V8 and must be abstracted.</p>
...
<h3>Nan::Error()</h3><p>Create a new Error object using the <a href="https://v8docs.nodesource.com/io.js-3.3/da/d6a/classv8_1_1_exception.html">v8::Exception</a> class in a way that is compatible across the supported versions of V8.</p>
<p>Note that an Error object is simply a specialized form of <code>v8::Value</code>.</p>
<p>Signature:</p>
...
<h3>Nan::RangeError()</h3><p>Create a new RangeError object using the <a href="https://v8docs.nodesource.com/io.js-3.3/da/d6a/classv8_1_1_exception.html">v8::Exception</a> class in a way that is compatible across the supported versions of V8.</p>
...
<h3>Nan::ReferenceError()</h3><p>Create a new ReferenceError object using the <a href="https://v8docs.nodesource.com/io.js-3.3/da/d6a/classv8_1_1_exception.html">v8::Exception</a> class in a way that is compatible across the supported versions of V8.</p>
...
<h3>Nan::SyntaxError()</h3><p>Create a new SyntaxError object using the <a href="https://v8docs.nodesource.com/io.js-3.3/da/d6a/classv8_1_1_exception.html">v8::Exception</a> class in a way that is compatible across the supported versions of V8.</p>
...
<h3>Nan::TypeError()</h3><p>Create a new TypeError object using the <a href="https://v8docs.nodesource.com/io.js-3.3/da/d6a/classv8_1_1_exception.html">v8::Exception</a> class in a way that is compatible across the supported versions of V8.</p>
...
<h3>Nan::ThrowError()</h3><p>Throw an Error object (a specialized <code>v8::Value</code> as above) in the current context. If a <code>msg</code> is provided, a new Error object will be created.</p>
<p>Signature:</p>
...
<h3>Nan::ThrowRangeError()</h3><p>Throw an RangeError object (a specialized <code>v8::Value</code> as above) in the current context. If a <code>msg</code> is provided, a new RangeError object will be created.</p>
<p>Signature:</p>
...
<h3>Nan::ThrowReferenceError()</h3><p>Throw an ReferenceError object (a specialized <code>v8::Value</code> as above) in the current context. If a <code>msg</code> is provided, a new ReferenceError object will be created.</p>
<p>Signature:</p>
...
<h3>Nan::ThrowSyntaxError()</h3><p>Throw an SyntaxError object (a specialized <code>v8::Value</code> as above) in the current context. If a <code>msg</code> is provided, a new SyntaxError object will be created.</p>
<p>Signature:</p>
...
<h3>Nan::ThrowTypeError()</h3><p>Throw an TypeError object (a specialized <code>v8::Value</code> as above) in the current context. If a <code>msg</code> is provided, a new TypeError object will be created.</p>
<p>Signature:</p>
...
<h3>Nan::FatalException()</h3><p>Replaces <code>node::FatalException()</code> which has a different API across supported versions of Node. For use with <a href="#api_nan_try_catch"><code>Nan::TryCatch</code></a>.</p>
<p>Signature:</p>
<pre><code class="language-c++">void Nan::FatalException(const Nan::TryCatch&amp; try_catch);
</code></pre>
<p><a name="api_nan_errno_exception"></a></p>
<h3>Nan::ErrnoException()</h3><p>Replaces <code>node::ErrnoException()</code> which has a different API across supported versions of Node. </p>
<p>Signature:</p>
...
<h3>Nan::TryCatch</h3><p>A simple wrapper around <a href="https://v8docs.nodesource.com/io.js-3.3/d4/dc6/classv8_1_1_try_catch.html"><code>v8::TryCatch</code></a> compatible with all supported versions of V8. Can be used as a direct replacement in most cases. See also <a href="#api_nan_fatal_exception"><code>Nan::FatalException()</code></a> for an internal use compatible with <code>node::FatalException</code>.</p>
<p>Signature:</p>
