<h1>detect-libc</h1><p>Node.js module to detect the C standard library (libc) implementation
...
<h2>Install</h2><pre><code class="language-sh">npm install detect-libc
</code></pre>
<h2>Usage</h2><h3>API</h3><pre><code class="language-js">const { GLIBC, MUSL, family, version, isNonGlibcLinux } = require(&#39;detect-libc&#39;);
</code></pre>
<ul>
...
<h3>detect-libc command line tool</h3><p>When run on a Linux system with a non-glibc libc,
...
<h2>Integrating with prebuild</h2><pre><code class="language-json">  &quot;scripts&quot;: {
...
<h2>Licence</h2><p>Copyright 2017 Lovell Fuller</p>
