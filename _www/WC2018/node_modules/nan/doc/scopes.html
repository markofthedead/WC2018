<h2>Scopes</h2><p>A <em>local handle</em> is a pointer to an object. All V8 objects are accessed using handles, they are necessary because of the way the V8 garbage collector works.</p>
...
<h3>Nan::HandleScope</h3><p>A simple wrapper around <a href="https://v8docs.nodesource.com/io.js-3.3/d3/d95/classv8_1_1_handle_scope.html"><code>v8::HandleScope</code></a>.</p>
<p>Definition:</p>
