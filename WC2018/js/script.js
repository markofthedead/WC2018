...
changeWatchlist = (country) => {
  const watchList = document.querySelectorAll('#channelList > li');
...
if (document.body.classList.contains('story')) {
    const countries = document.querySelectorAll('#channelList li h4');
   ...
   countrySelect.addEventListener("change", (e) => { //TODO: Store selection in cookie
